    ...
    <div class="application">
        <div class="container-fluid">
            <div class="panel-heading">
                <h2 class="text-left">Notification Applications</h2>
...
import DialogContainer from "./AddEditNotificationApplication.vue";
...
export default ({
    ...
    dialogTitle() {
      return `${this.applicationModel.id === undefined ? "Add" : "Edit"} Notification Application`;
        }
    },
    methods: {
    ...
    async registerApplication(dataItem){
        ...
        try{
          await axios.post(this.base_url + "registerapplication/"+dataItem.applicationKey).then((response) => {
            this.getApplications();
    ...
    async updateApplication(dataItem){
        ...
        try{
          var dataToBePosted = {
              id : dataItem.id,
              applicationKey : dataItem.applicationKey
          };
