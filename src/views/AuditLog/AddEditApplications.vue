  ...
  <k-dialog @close="cancel" :max-width="400" :title="action">
    ...
    <form class="k-form" @submit.prevent="save">
      ...
      <div style="width: 50vw">
        ...
        >
          <label class="col-sm-3 text-left col-form-label"> Application Name<span class="c-danger">*</span>: </label>
          <div class="col-sm-9">
            <k-input
              type="text"
              :name="'name'"
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      // this.$emit("save");
       this.errors = [];
         if($.trim(this.applicationModel.name) == ""){
           this.applicationModel.name = undefined;
        this.errors.push("Please enter an Application Name.");
      }
      if($.trim(this.applicationModel.key) == "" ){
        this.applicationModel.key = undefined;
        this.errors.push("Please enter an Application Key.");
      }
      if(this.applicationModel.name && this.applicationModel.key){
        this.errors = [];
        this.$emit("save");
      }
    },
